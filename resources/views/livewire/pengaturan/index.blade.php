...
<div>
    ...
    <x-card title="Backup Data" class="max-w-2xl mt-4">
        <p class="text-sm text-slate-600">
            Unduh seluruh data bisnis (mahasiswa, IPK, prestasi, tracer, promosi, hasil
            klasterisasi, pengaturan, dan daftar pengguna tanpa kata sandi) sebagai satu
            berkas JSON untuk pencadangan.
        </p>
        <div class="mt-4">
            <x-button variant="secondary" :href="route('pengaturan.backup')">
