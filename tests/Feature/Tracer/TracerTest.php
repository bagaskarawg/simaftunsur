...
beforeEach(function () {
    ...
    $this->staf = Pengguna::factory()->create(['peran' => 'staf']);       // tracer.kelola + lihat
    $this->kaprodi = Pengguna::factory()->create(['peran' => 'kaprodi']); // tracer.lihat saja
    $this->dosen = Pengguna::factory()->create(['peran' => 'dosen']);     // tanpa izin tracer
});
